...
async function fillTable()
{
    ...
    {
        if(Math.abs(GalaxyData[e].fc) < fc_threshold && $("#gal_checkbox_fc_enable")[0].checked)
            continue;
        ...
        if( $("#gal_checkbox_pvalue_enable")[0].checked)
        {
            ...
            {
                if(GalaxyData[e].pvalue_adj > pvalue_threshold)
                    continue;
            }
            else 
            {
                if(GalaxyData[e].pvalue > pvalue_threshold)
                    continue;
            }
        }
